    ...
    <div data-header-top>
        ...
        <div class="flex justify-between items-center py-2 desktop:py-3">
            ...
            <div class="flex desktop:hidden items-center gap-x-2.5" data-menu-open>
                <button class="btn btn--accent-smooth p-1.5 text-sm leading-6">{{ __('header.action_button') }}</button>
    ...
    <div class="container" data-header-botton-height>
        <div class="flex items-center justify-between py-2.5 desktop:py-4 border-y border-border-main-dark">
            ...
            <div class="w-full desktop:w-auto flex items-center gap-x-10">
                <nav class="w-full desktop:w-auto flex items-center gap-6 text-main-dark overflow-x-auto">
                    <a href="#" class="flex items-center gap-2 text-nowrap">
                        <svg class="w-4 h-4 fill-main-dark" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M1 0H15C15.2652 0 15.5196 0.105356 15.7072 0.292892C15.8947 0.480429 16 0.734784 16 1V8H15V15C15 15.2652 14.8947 15.5196 14.7072 15.7071C14.5196 15.8946 14.2652 16 14 16H2C1.73478 16 1.48038 15.8946 1.29285 15.7071C1.10531 15.5196 1 15.2652 1 15V8H0V1C0 0.734784 0.10531 0.480429 0.292847 0.292892C0.480383 0.105356 0.734784 0 1 0ZM14 2H12V6H14V2ZM10 2H6V6H10V2ZM4 2H2V6H4V2ZM5 10H11V14H13V8H3V14H5V10ZM9 12H7V14H9V12Z" fill-opacity="0.2"/>
                        </svg>
